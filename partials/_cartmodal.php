            ...
            <div class="modal-content" style=" border:none; border-radius: 20px;">
                <div class="modal-header ">
                    ...
                    <div class="btn-group " style="margin:auto;" role="group" aria-label="Basic radio toggle button group">
                        <input type="radio" class="btn-check" name="btnradio" id="service1" autocomplete="off" checked>
                        <label class="btn btn-outline-danger" onclick="showservice()" for="service1">Services</label>

                        <input type="radio" class="btn-check" onclick="showgarage()" name="btnradio" id="garage1" autocomplete="off">
                        <label class="btn btn-outline-danger" for="garage1">Garages</label>  
