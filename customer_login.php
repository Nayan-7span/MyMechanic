    ...
    <div class="form-container">
        <div class="field-container">
            <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="customer-form">
                <h2 class="form-field" style="font-weight: bold; color:white; text-align:center"> Customer Login <i
                ...
                <p style="font-weight: bold; color:white">Enter Email</p>
                    ...
                    oninvalid="this.setCustomValidity('Enter Valid Email it contains \'@\' or\'.\' ')" onchange="this.setCustomValidity('')" pattern=".+@gmail\.com"  required="required" />
                </div>
                ...
                <a href="Forget_password.php?crreset" style="color:white;">Forget password</a>
