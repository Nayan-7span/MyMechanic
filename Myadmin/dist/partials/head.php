...
<a href="http://localhost/final-project/MyMechanic/phpreport/service_categoryrpt.php" type="button"  class="btn btn-warning btn-sm position-relative my-2">
...
<i class="bi bi-envelope-fill"></i> Feedbacks
    ...
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
        <div class="sb-sidenav-menu">
            <div class="nav">
                ...
                <a class="nav-link" style="padding: 9px 15px" href="categories.php">
                    <div class="sb-nav-link-icon"><i class="bi bi-bookmark-check-fill"></i></div>
                    Categories
                </a>    
                <a class="nav-link" style="padding: 9px 15px" href="services.php">
                    <div class="sb-nav-link-icon"><i class="bi bi-gear-fill"></i></div>
                    Services
                </a>
                <a class="nav-link" style="padding: 9px 15px" href="payment.php">
                    <div class="sb-nav-link-icon"><i class="bi bi-cash-coin"></i></div>
                    Payment
                </a>
                <a class="nav-link" style="padding: 9px 15px" href="order.php">
                ...
                <a class="nav-link"  style="padding: 9px 15px" href="admin.php">
                    <div class="sb-nav-link-icon"><i class="bi bi-person-fill me-2"></i></div>
                    Admin
                </a>
                <a class="nav-link" style="padding: 9px 15px" href="customer.php">
                    <div class="sb-nav-link-icon"><i class="bi bi-people-fill me-2"></i></div>
                    Customers
                </a>
                <a class="nav-link" style="padding: 9px 15px" href="garageowner.php">
                    <div class="sb-nav-link-icon"><i class="bi bi-hammer me-2"></i></div>
                    Garage Owners
                </a>
                <a class="nav-link" style="padding: 9px 15px" href="approve.php">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input id="uadminphoto"  name="uadminphoto" type="file" />
                        ...
                        <input type="email" maxlength="50" class="form-control my-1" id="uadminemail" name="uadminemail" value="' . $adminrow['a_email'] . '" placeholder="Enter Admin E-Mail" disabled>
