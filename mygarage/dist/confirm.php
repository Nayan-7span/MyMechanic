    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                <h3 class="mt-4"><i class="bi bi-card-checklist"></i> Confirmed Service </h3>
                <hr>
                <!-- Alert messages  -->
                <?php
                if ($alerterror)
                    ...
                    <div class="card mb-4">
                        <div class="card-header" style="background-color:#f3f3f3; color:#c71e2f;">
                            <form action="confirm.php" method="POST">
                                ...
                                $all = "";
                                $today = "checked";
                                $message = "service that you need to do complete today!";
                                if ($_SERVER['REQUEST_METHOD'] == "POST" && $_POST['btnradio'] == "all") {
                                    $today = "";
                                    $all = "checked";
                                    $message = "All servieces you have accepted!";
                                }
                                ...
                                <div class="btn-group" class="mx-2" style="float: right;" role="group" aria-label="Basic radio toggle button group">
                                    ...
                                    <label class="btn btn-outline-success border border-secondary" for="btnradio1"><strong>Work for Today</strong></label>
                        ...
                        <div class="card-body">
                            <table id="datatablesSimple6">
                                ...
                                <tbody>
                                    ...
                                    if ($_SERVER['REQUEST_METHOD'] == "POST" && $_POST['btnradio'] == "all") {
                                        $acceptbook = "SELECT *FROM `booking` WHERE  `bk_status` = 'confirm' AND `gr_id` = $garage_id";
                                    ...
                                    while ($bookrow = mysqli_fetch_assoc($bookresult)) {
                                        ...
                                        <td style="max-width:100px">
                                            <a href="confirm.php?complete=' . $bookrow['bk_id'] . '" type="button" class="btn btn-success  btn-sm px-1"><i class="bi bi-check-circle"></i> Complete</a>
                                            <a href="confirm.php?decline=' . $bookrow['bk_id'] . '" type="button" style="width:100%" class="btn btn-danger  btn-sm my-1"><i class="bi bi-x-circle"></i> decline</a>
                                        </td>
                                        ...
                                        //Displaying today service tasks END
                                        else {
                                            if ($serdate == $today) {
                                                echo '<tr class="' . $row_color . '">
                                            <td>
