...
if (isset($_GET['addlabel'])) {
    ...
    if ($totalcat < 2 || $totals < 1 || $imagevalid == true) {
        if ($totalcat < 2 || $totals < 1) {
            $alerterror = "Please Enter At least 2 Category and 1 service  in Your Garage!!";
        }
        if ($imagevalid == true) {
    ...
    <div id="layoutSidenav_content">
        <main>
            ...
            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                ...
                <?php
                if ($num2 > 0) {
                    echo '<h4 class="mt-3" style="display:inline-block"><i class="bi bi-bookmark-check-fill"></i> View of Internal label</h4>
                    <a href="mygarage.php?updatelabel"  type="button" class="btn btn-success  btn-sm "><i class="bi bi-pencil-fill"></i> Edit Label</a>
