    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-3">
                                <div class="statistic__item statistic__item--red">
                                    <?php
                                    $sql1 = "SELECT *FROM `category` WHERE `cat_by` = $gr_id";
                                    $result1 = mysqli_query($conn, $sql1);
                                    $num1 = mysqli_num_rows($result1);

                                    ?>
                                    <h2 class="number"><?php echo $num1 ?></h2>
                                    <span class="desc">Toal Categories in Garage</span>
                                    <div class="icon">
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="statistic__item statistic__item--orange">
                                    <?php
                                    $sql2 = "SELECT *FROM `service` WHERE `s_by` = $gr_id";
                                    $result2 = mysqli_query($conn, $sql2);
                                    $num2 = mysqli_num_rows($result2);
                                    ?>
                                    <h2 class="number"><?php echo $num2 ?></h2>
                                    <span class="desc">Total Service in Garage</span>
                                    <div class="icon">
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="statistic__item statistic__item--green">
                                    <?php
                                    $sql3 = "SELECT *FROM `booking` WHERE `gr_id` = $gr_id AND `bk_status` = 'complete'";
                                    $result3 = mysqli_query($conn, $sql3);
                                    $num3 = mysqli_num_rows($result3);
                                    ?>
                                    <h2 class="number"><?php echo $num3 ?></h2>
                                    <span class="desc">Total Services Completed</span>
                                    <div class="icon">
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="statistic__item statistic__item--blue">
                                    <?php
                                    $sql4 = "SELECT SUM(pay_amount) AS `total_sum` FROM `payment` WHERE `gr_id` = $gr_id";
                ...
                <ol class="breadcrumb mb-4">
                    <li class="breadcrumb-item active">
                        <h3><i class="bi bi-bar-chart"></i> This Month statistics</h3>
                    </li>
                </ol>
                <section class="statistic statistic2">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-6 col-lg-3">
                                <div class="statistic__item statistic__item--grey">
                                    ...
                                    <?php
                                    $sql4 = "SELECT *FROM `booking` WHERE `gr_id` = '$gr_id' AND `bk_status` = 'placed' ";
                                    $result4 = mysqli_query($conn, $sql4);
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="statistic__item statistic__item--grey">
                                    ...
                                    $sql5 = "SELECT *FROM `booking` WHERE (`gr_id` = '$gr_id' AND `bk_status`= 'complete') AND (`sr_date` BETWEEN '$year-$month-01' AND '$year-$month-30')";
                            ...
                            <div class="col-md-6 col-lg-3">
                                <div class="statistic__item statistic__item--grey">
                                    ...
                                    $sql5 = "SELECT *FROM `booking` WHERE (`gr_id` = '$gr_id' AND `bk_status`= 'decline') AND (`sr_date` BETWEEN '$year-$month-01' AND '$year-$month-30')";
                                    $result5 = mysqli_query($conn, $sql5);
                                    $num5 = mysqli_num_rows($result5);
                                    ?>
                                    <h2 class="todaystath1"><?php echo $num5 ?></h2>
                            ...
                            <div class="col-md-6 col-lg-3">
                                ...
                                <h1><i class="bi bi-bar-chart-fill todayi" style="color:#00a0cc" id="todayi2"></i></h1>
                                    ...
                                    $sql6 = "SELECT SUM(pay_amount) as `thisrev` FROM `payment` WHERE `gr_id` = '$gr_id' AND (`pay_date` BETWEEN '$year-$month-01' AND '$year-$month-30')";
