...
//
// Table class for booking date
//
class crbooking_date extends crTableBase {
	...
	function __construct() {
		...
		$this->TableVar = 'booking_date';
		$this->TableName = 'booking date';
		$this->TableType = 'VIEW';
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// bk_id
		$this->bk_id = new crField('booking_date', 'booking date', 'x_bk_id', 'bk_id', '`bk_id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// cr_id
		$this->cr_id = new crField('booking_date', 'booking date', 'x_cr_id', 'cr_id', '`cr_id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// sr_id
		$this->sr_id = new crField('booking_date', 'booking date', 'x_sr_id', 'sr_id', '`sr_id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// gr_id
		$this->gr_id = new crField('booking_date', 'booking date', 'x_gr_id', 'gr_id', '`gr_id`', 3, EWR_DATATYPE_NUMBER, -1);
		...
		// bk_date
		$this->bk_date = new crField('booking_date', 'booking date', 'x_bk_date', 'bk_date', '`bk_date`', 133, EWR_DATATYPE_DATE, 0);
		...
		$this->bk_date->SqlSelect = "SELECT DISTINCT `bk_date`, `bk_date` AS `DispFld` FROM " . $this->getSqlFrom();
		$this->bk_date->SqlOrderBy = "`bk_date`";

		// sr_date
		$this->sr_date = new crField('booking_date', 'booking date', 'x_sr_date', 'sr_date', '`sr_date`', 135, EWR_DATATYPE_DATE, 0);
		...
		// sr_city
		$this->sr_city = new crField('booking_date', 'booking date', 'x_sr_city', 'sr_city', '`sr_city`', 200, EWR_DATATYPE_STRING, -1);
		...
		// car_model
		$this->car_model = new crField('booking_date', 'booking date', 'x_car_model', 'car_model', '`car_model`', 200, EWR_DATATYPE_STRING, -1);
		...
		// sr_by
		$this->sr_by = new crField('booking_date', 'booking date', 'x_sr_by', 'sr_by', '`sr_by`', 200, EWR_DATATYPE_STRING, -1);
		...
		// bk_status
		$this->bk_status = new crField('booking_date', 'booking date', 'x_bk_status', 'bk_status', '`bk_status`', 200, EWR_DATATYPE_STRING, -1);
	...
	function getSqlFrom() {
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`booking date`";
	}
