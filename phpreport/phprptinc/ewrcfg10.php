...
define("EWR_PROJECT_ID", "{6023486a-23bf-47d2-ae33-1cb933dc9fbf}", TRUE); // Project ID
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "mymechanic", "qs" => "`", "qe" => "`");
...
// General
$EWR_ROOT_RELATIVE_PATH = "..\..\..\..\..\Users\nayan\OneDrive\Documents\PHPReportMaker\WebSites\project1"; // Relative path of app root
define("EWR_UNFORMAT_YEAR", 50, TRUE); // Unformat year
define("EWR_RANDOM_KEY", 'fDpq52c1s1yyMOl0', TRUE); // Random key for encryption
