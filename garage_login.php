    ...
    <div class="form-container">
        <div class="field-container">
            <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="customer-form">
                <h2 class="form-field" style="font-weight: bold; color:white; text-align:center"> Garage Owner Login <i class="bi bi-card-checklist"></i></h2>
                <hr style="height:4px; background-color: Red;">
                <div class="form-field mb-3">
                <p style="font-weight: bold; color:white">Enter Email</p>
                    <input type="email" maxlength="50" class="form-control" id="email" name="email"   oninvalid="this.setCustomValidity('Enter Valid Email it contains \'@\' or \'.\' ')" onchange="this.setCustomValidity('')" pattern=".+@gmail\.com" required="required" />
                </div>
